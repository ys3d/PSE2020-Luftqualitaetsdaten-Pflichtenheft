...
\subsection{Musskriterien}
 \begin{itemize}
	...
	\item Der Nutzer kann einen Punkt auf der Landkarte auswählen und erhält eine zugehörige \gls{Sensoroverview}. Es werden \glslink{Interpolation}{interpolierte} Messwerte zu \gls{Feinstaub}, Luftdruck, Luftfeuchtigkeit, Temperatur angezeigt. Hier soll dem Nutzer ebenfalls ein Diagramm zur zeitlichen Entwicklung der \glslink{Interpolation}{interpolierten} Messwerte zur Verfügung stehen.
