...
\begin{tabularx}{\textwidth}{| c | X | X | c |}
    ...
    \hline
    /T100/ & In der Suchleiste wird eine Stadt eingegeben. & Zoomt die Karte an den gesuchten Standort & /F030/ \\
    \hline
    /T0110/ & In der Suchleiste wird eine Postleitzahl eingegeben & Zoomt die Karte an den gesuchten Standort &  /F030/ \\
    \hline
...
\begin{tabularx}{\textwidth}{| c | X | X | c |}
    ...
    \hline
    /T320/ & Hilfefunktion in der \gls{Toolbar}, die die unterschiedlichen Funktionen erklärt & Ermöglicht es Benutzern, die Probleme mit der Schnittstelle haben, leichter mit dieser umzugehen & \\
    \hline
    /T330/ & Zugriff der Schnittstelle über \gls{Standart-PC} als auch über Handys & Ermöglicht es dem Benutzer auf die Schnittstelle über unterschiedliche Endgeräte zuzugreifen & \\
    \hline 
\end{tabularx}
