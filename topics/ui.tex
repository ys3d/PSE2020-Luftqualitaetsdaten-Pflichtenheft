...
Als erste Ansicht der Webapplikation soll eine Deutschlandkarte mit farbigen \glspl{Kartenoverlay} geladen werden. Die farbigen \glspl{Kartenoverlay} geben hierbei Feinstaubdaten wieder.
...
Er kann in der \gls{Toolbar} auswählen welche \gls{Luftqualitaetsdaten} er mit farbigen \glspl{Kartenoverlay} auf der Landkarte angezeigt haben möchte. 
...
Zu diesem Zweck sollen Feinstaubdaten als farbige \glspl{Kartenoverlay} auf einer Deutschlandkarte mit Zeitachse angezeigt werden. 
...
\subsubsection{Definition von \gls{Feinstaub}}
...
\begin{center}
	...
	\includegraphics[width=0.9\textwidth]{media/SmartAQnet}\captionof{figure}{SmartAQnet} 
