...
Als erste Ansicht der Webapplikation soll eine Deutschlandkarte mit farbigen Kartenoverlays geladen werden. Die farbigen Kartenoverlays geben hierbei Feinstaubdaten wieder.
...
\subsection{Screenshots Mobile Version}
	...
	\begin{minipage}[b]{.5\linewidth} % [b] => Ausrichtung an \caption
		\includegraphics[width=0.7\textwidth]{media/Startseite-Mobile-Version}\captionof{figure}{Startseite} 
	\end{minipage}
	\hspace{.05\linewidth}% Abstand zwischen Bilder
	\begin{minipage}[b]{.5\linewidth} % [b] => Ausrichtung an \caption
		\includegraphics[width=0.7\textwidth]{media/Menue-Mobile-Version}\captionof{figure}{Menue} 
	\end{minipage}
	\begin{minipage}[b]{.5\linewidth} % [b] => Ausrichtung an \caption
		\includegraphics[width=0.7\textwidth]{media/AktuelleDaten-Mobile-Version}\captionof{figure}{Aktuelle Daten} 
	\end{minipage}
