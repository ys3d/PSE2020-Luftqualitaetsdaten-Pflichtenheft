...
Als erste Ansicht der Webapplikation soll eine Deutschlandkarte mit farbigen Overlays geladen werden. Die farbigen Overlays geben hierbei Feinstaubdaten wieder.
Die Webapplikation kann von einem ausklappbaren Toolbar aus bedient werden. Von dort aus sind die verschiedenen Seiten der Webapplikation erreichbar und deren Funktionen abrufbar. 
...
child { node [optional]{Verlinkung zu einer Bauanleitung für einen DIY-Sensor}}
...
child [missing] {}
child { node [optional] {Gesundheitsrisiken bei obigen Messwerten}};
\end{tikzpicture}
...
\begin{center}
	...
	\includegraphics[width=0.9\textwidth]{Screenshots/SmartAQnet}\captionof{figure}{SmartAQnet} 
	
	\includegraphics[width=0.9\textwidth]{Screenshots/DIY}\captionof{figure}{Verlinkung zu einer Bauanleitung für einen DIY-Sensor} 
\end{center}
